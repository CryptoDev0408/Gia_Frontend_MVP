...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-brand-bg/50 relative overflow-hidden">
      ...
      >
        <source src="https://gia-files.vercel.app/live-wall2.mp4" type="video/mp4" />
      </video>
            ...
            <div className="flex justify-center">
              <div className="relative w-fit">
                ...
                <div className="relative">
                  ...
                  >
                    <source src="https://gia-files.vercel.app/PixVerse_V5_Image_Text_720P_Turn_this_still_im.mp4" type="video/mp4" />
                  </video>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="relative w-fit mx-auto mb-4">
                ...
                <div className="relative">
                  ...
                  >
                    <source src="https://gia-files.vercel.app/PixVerse_V5_Image_Text_720P_Turn_this_still_ims.mp4" type="video/mp4" />
                  </video>
                </div>
              </div>
            </div>
